...
6. Ask the desired business task, problem, or goal in plain language. `scripts/route_task.py` sends clear jobs directly to installed owners and sends uncertain/broad requests through Core intent resolution instead of guessing an unrelated atomic process.
