...
def run_control_flags(run_dir,workspace=None):
    ...
    # Current blind launchers capture candidate stdout under evaluator/logs. Keep the
    # historical candidate-logs location so frozen pre-blind runs remain evaluable.
