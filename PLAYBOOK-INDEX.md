...
- `seo.diagnosis.detector.organic-experience-alignment` — Organic Experience Alignment Detector: Detect when organic acquisition intent, ranking destination, search promise, or landing experience is misaligned and distinguish SEO acquisition problems from broader persuasion/journey friction.
...
- `seo.diagnosis.detectors.backlink-gap` — Authority / Backlink Gap Detector: Find relevant authority relationships/assets competitors or the topic ecosystem have that the brand could legitimately earn.
- `seo.diagnosis.detectors.cannibalization` — Cannibalization / Intent Ownership Detector: Find multiple owned assets competing or confusing intent ownership where consolidation or differentiation may improve outcomes.
...
- `seo.diagnosis.detectors.ranking-decay` — Ranking Decay Detector: Detect sustained loss of position/visibility for valuable demand and identify the likely scope/mechanism.
- `seo.diagnosis.detectors.ranking-upside` — Ranking Upside Detector: Find Assets already visible for valuable demand where a realistic relevance/quality/authority improvement could materially increase business value.
...
- `seo.diagnosis.detectors.technical` — Technical Opportunity Detector: Convert crawl/index/performance observations into evidence-backed root-cause technical opportunities.
- `seo.diagnosis.detectors.traffic-decay` — Organic Traffic Decay Detector: Separate material traffic decline into demand, visibility, CTR/result, analytics, conversion-path, and technical explanations.
...
- `seo.incidents.ranking-collapse` — Ranking Collapse Incident: Rapidly understand and recover from a broad or high-value ranking/visibility collapse without turning AURA into an incident-control runtime.
