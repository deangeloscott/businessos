...
3. Treat host Skills/plugins/tools as executors **inside** that AURA Run, not alternate operating systems around it. They may determine how to perform an allowed step but do not replace AURA routing, context, evidence, authorization, canonical state, QA, completion, history, or Learning.
