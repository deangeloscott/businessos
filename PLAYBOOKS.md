...
This copy currently includes **477 detailed playbooks** across the installed BusinessOS areas. The contracts and process maps remain the source of truth; this guide is only a simpler view of them.
...
### [BusinessOS Core](docs/playbooks/core.md)
