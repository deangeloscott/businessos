...
AURA helps an AI understand the business, reuse useful context and evidence, do real work through the tools available to it, and preserve what should matter later.

AURA is **not** the AI itself. It is also not a required cloud service, scheduler, provider router, permission system, or proprietary runtime.
...
2. **Give an AI tool access to the AURA folder.**
...
**New to AURA or AI tools? Read `BEGINNERS-GUIDE.md`.** It explains the basics, what AURA remembers, how to update safely, how several AI tools or computers can share AURA, optional tools such as Git and Markdown notes apps, and common problems.
...
See **`PLAYBOOKS.md`** to browse AURA's installed capabilities. A capable AI may use an AURA playbook, adapt one, use a specialist Skill, or use another sound method when that produces better work.
...
- **Portable:** the basic experience can be one local folder.
...
- **`BEGINNERS-GUIDE.md`** — start here if you are new to AURA or want the clearest full guide
...
- **`CONTEXT.md`** — instructions for AI agents using AURA
...
**The intended experience is simple:** give an AI access to AURA, tell it about the business and desired outcome, let it use relevant organizational memory and operating knowledge, and preserve what will make future work better.
