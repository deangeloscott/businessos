...
## 5. Cognitive Framing: Awareness Stages & Temporal Horizons
...
## 6. Fast-Lookup Decision Matrices
...
* **[`03-body-worn-apparel.md`](03-body-worn-apparel.md)** — 15 archetypes for fashion, footwear, bags, and wearables.
* **[`04-countertop-appliances.md`](04-countertop-appliances.md)** — 15 archetypes for kitchen appliances, espresso gear, and power stations (1.5–3').
* **[`05-architectural-macro.md`](05-architectural-macro.md)** — 15 archetypes for saunas, furniture, cold plunges, and home gyms (3–10+').
* **[`06-mobility-transport.md`](06-mobility-transport.md)** — 15 archetypes for e-bikes, scooters, cargo rigs, and overland transport (4–12+').
...
* **Harold M. Merklinger:**
  ...
  * *Key Frameworks Used:* Depth of field calculation in macro and close-up photography; optical bokeh drop-off curves (`f/1.8`–`f/2.8` subject isolation vs. `f/8`–`f/11` edge-to-edge product sharpness).
  * *Seminal Work:* *The INs and OUTs of FOCUS: An Alternative Way to Estimate Depth-of-Field and Sharpness in the Photographic Image* (1992).
...
* **Rolf Reber, Norbert Schwarz, & Piotr Winkielman:**
  ...
  * *Key Frameworks Used:* High processing fluency correlates directly with perceived truth, trust, and product value; visual clutter and competing background focal points decrease fluency and depress conversion.
...
* **Joann Peck & Terry L. Childers:**
  * *Primary Contribution:* The "Need for Touch" (NFT) in consumer decision making.
  * *Key Frameworks Used:* Instrumental vs. Autotelic touch; overcoming the "Tactile Uncertainty Gap" in digital e-commerce through high-resolution micro-texture, swatch viscosity, and dermal absorption imagery (The Proof & The Ritual classes).
...
* **Michael I. Norton, Daniel Mochon, & Dan Ariely:**
  ...
  * *Key Frameworks Used:* Depicting unboxing, assembly, and daily ritual maintenance to anchor value in the user's perceived interaction effort.
  * *Seminal Work:* "The IKEA Effect: When Labor Leads to Love" (*Journal of Consumer Psychology*, 2012).
...
* **Matt Pharr, Wenzel Jakob, & Greg Humphreys:**
  ...
  * *Key Frameworks Used:* Contact occlusion shadows, Fresnel reflectance, microfacet surface scattering, and ambient occlusion invariants to eliminate synthetic "floating" product artifacts.
...
* **Masahiro Mori:**
  ...
  * *Key Frameworks Used:* Identifying and eliminating synthetic AI artifacts (plastic waxy skin, ungrounded shadows, unnatural geometry) through explicit negative constraint prompting (Block 5).
  * *Seminal Work:* "The Uncanny Valley" (*Energy*, 1970).

### V. E-Commerce Conversion Benchmarks & Direct-Response Strategy
* **Baymard Institute:**
