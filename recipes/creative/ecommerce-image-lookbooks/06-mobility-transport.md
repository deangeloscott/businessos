...
2. *Spatial / Storage Dread:* "Can I fit this in my apartment, car trunk, or elevator?"
...
### Archetype 01: The Compliant Studio Side-Profile Hero
* **Universal Class:** The Specimen
* **Example Products (Illustrative Guidance, Not an Allowlist):** Commuter e-bike, electric stand-up scooter, single-wheel electric board, overland cargo trailer, carbon gravel bike.
1. **Strategic Intent & Conversion Role:**  
   Shopify & Catalog Main Hero (Slot 1). Flawless, distortion-free view of frame geometry, wheelbase proportions, tire tread, and drive-train components.
2. **The Physical Stage (The 95%):**  
   Pure seamless neutral white cyclorama (RGB 255, 255, 255). The e-bike, scooter, or trailer is positioned in true parallel side-profile (drive-side facing the camera), resting solidly on its tires.
3. **Optical & Lighting Directives:**  
   * *Lens:* 85mm Prime positioned 15 feet back at axle height to eliminate perspective keystoning (both wheels appear identical in size).  
   * *Aperture:* f/8 to f/11 for corner-to-corner mechanical sharpness.  
   * *Lighting:* Commercial automotive studio softbox array casting long, smooth highlight ribbons along the top tube, down tube, and wheel rims.  
   * *Shadow:* Crisp, razor-thin black contact shadow directly under both tire contact patches.
...
[BLOCK 2: OPTICAL RIG]: 85mm prime lens at axle height, f/9 aperture for corner-to-corner focal sharpness across both wheels with zero perspective keystoning.
[BLOCK 3: LIGHTING RIG]: Clean 5500K commercial automotive studio softbox lighting casting smooth specular highlights down the hydroformed downtube, with crisp black contact shadows beneath tire tread patches.
...
[BLOCK 5: EXCLUSIONS]: Negative: floating shadows, colored backgrounds, kickstand clutter, distorted wheel sizes, street clutter, blurry frame text.
```

---

### Archetype 02: The Kinetic Urban Commute (Panning Velocity)
* **Universal Class:** The Ritual
* **Example Products (Illustrative Guidance, Not an Allowlist):** Commuter e-bike, belt-drive city bike, high-speed electric scooter, performance electric skateboard.
1. **Strategic Intent & Conversion Role:**  
...
3. **Optical & Lighting Directives:**  
   ...
   * *Lighting:* Low-angle morning sunlight casting golden highlights along the frame and rider's helmet.
4. **Sensory & Synesthetic Triggers:**  
   Kinetic wind in your face, the silent whir of a brushless hub motor, effortless conquest of city traffic.
5. **Invariant Guardrails & Crop Safe-Zones:**  
...
[BLOCK 5: EXCLUSIONS]: Negative: blurry bike frame, stalled traffic, unhelmeted rider, messy suburban clutter, dark underexposed shadows.
```

---

### Archetype 03: The Battery Swap & Modular Charging Access
* **Universal Class:** The Ritual
...
### Archetype 04: The Trunk-Fold & Compact Spatial Proof
* **Universal Class:** The Specimen
...
### Archetype 05: The Cockpit, Handlebar & Display Interface Macro
* **Universal Class:** The Proof
* **Example Products (Illustrative Guidance, Not an Allowlist):** Smart e-bike cockpit, electric scooter heads-up display, GPS cargo console, e-motorcycle digital dash.
1. **Strategic Intent & Conversion Role:**  
...
### Archetype 06: The Cargo Capacity & Utility Rigging
...
### Archetype 07: The Overland Wilderness Camp Setup
* **Universal Class:** The Habitat
* **Example Products (Illustrative Guidance, Not an Allowlist):** Hard-shell rooftop tent on SUV, overland adventure trailer, fat-tire backcountry e-bike, expedition rack.
1. **Strategic Intent & Conversion Role:**  
   Adventure Flagship & Category Hero (Rooftop Tents, Overland Rigs, Trail E-Bikes). Sells the ultimate aspirational dream of self-contained wilderness exploration.
2. **The Physical Stage (The 95%):**  
   A remote alpine ridgeline or desert canyon at sunset. The vehicle has its hard-shell rooftop tent fully deployed with aluminum ladder extended, surrounded by rugged nature. Warm ambient camp light glows from inside the tent.
3. **Optical & Lighting Directives:**  
...
* **Director's Rig Prompt Blueprint:**
```text
[BLOCK 1: HERO OVERLAND EXPEDITION]: Commercial adventure photograph of [HERO PRODUCT: Rooftop tent deployed on overland rig / all-terrain e-bike] at a remote wilderness camp, commanding 65% of frame weight in tack-sharp focus.
[BLOCK 2: ADVENTURE DETAIL]: Tent is fully deployed with taut ripstop canvas, extended aluminum ladder, and glowing 2700K warm interior lantern light cutting through the dusk.
[BLOCK 3: OPTICS]: 35mm prime lens, level eye-line, f/5.6 aperture for deep landscape clarity.
[BLOCK 4: STAGE & LIGHT]: Spectacular golden-hour sunset backlighting mountain peaks and desert canyon, background 2 stops darker.
[BLOCK 5: EXCLUSIONS]: Negative: saggy canvas, crowded RV park, trash, cheap plastic camp chairs, distorted vehicle proportions.
```

---

### Archetype 08: The Night Commuter Safety & Lighting Architecture
* **Universal Class:** The Proof
...
### Archetype 11: The Ergonomic Geometry, Standover & Dimensional Fit Blueprint
* **Universal Class:** The Specimen
...
2. **The Physical Stage (The 95%):**  
   ...
   * Minimum and maximum saddle adjustment range.
   * Handlebar reach and cockpit angle.
   * Wheelbase and total bumper-to-bumper length.
3. **Optical & Lighting Directives:**  
   * *Lens / Perspective:* 135mm Telephoto at axle height with zero keystoning or wheel distortion.  
   * *Aperture:* f/11 for absolute corner-to-corner mechanical sharpness.  
   * *Lighting:* Clean, shadowless high-key technical lighting with high-contrast graphic callouts.
4. **Sensory & Synesthetic Triggers:**  
   Engineered reassurance and personalized ergonomic fit: instantly visualizing oneself straddling the frame, effortlessly putting a foot down at traffic stops.
5. **Invariant Guardrails & Crop Safe-Zones:**  
   Dimensions must be mathematically accurate to manufacturer CAD specs in both Imperial (inches) and Metric (cm).
* **Director's Rig Prompt Blueprint:**
```text
[BLOCK 1: HERO DIMENSIONAL BLUEPRINT]: Commercial technical sizing specification photograph of [HERO PRODUCT: E-bike / scooter] in pure parallel side-profile orthographic projection, occupying 85% of frame width in tack-sharp focus.
[BLOCK 2: GEOMETRY DETAIL]: Clean graphic architectural overlay lines indicate standover height, minimum/maximum seat height adjustment, and total bumper-to-bumper length on an architectural CAD grid.
[BLOCK 3: OPTICS]: 135mm telephoto lens at axle height, f/11 aperture for edge-to-edge optical sharpness with zero wheel distortion.
[BLOCK 4: STAGE & LIGHT]: Seamless high-key technical background (RGB 245, 245, 248) with subtle shadow beneath tires.
[BLOCK 5: EXCLUSIONS]: Negative: perspective keystoning, fish-eye warping, distracting riders, messy backgrounds, unreadable dimension text.
```
...
### Archetype 13: The Close-Tracking 45° Axle-Height Velocity
* **Universal Class:** The Ritual
* **Example Products (Illustrative Guidance, Not an Allowlist):** Belt-drive commuter e-bike, high-speed electric scooter, urban gravel adventurer rig, single-speed city bike.
1. **Strategic Intent & Conversion Role:**  
   Hero Landing Page Header & Brand Equity (Kinetic Freedom & Engineering Prestige). Puts frame geometry, carbon belt drive, and disc brakes front and center, eliminating the "scenery postcard" trap.
2. **The Physical Stage (The 95%):**  
   Close-tracking commercial hero shot captured from a 45° front-three-quarter profile at axle height. The vehicle frame, hydroformed downtube, and hydraulic disc brakes occupy 75% of the frame in tack-sharp foreground focus.
3. **Optical & Lighting Directives:**  
   * *Lens:* 50mm Prime at axle height.  
   * *Shutter Speed:* 1/40s smooth horizontal tracking blur.  
   * *Lighting:* Low-angle twilight or dusk ambient with bridge lights streaking into soft horizontal motion bokeh.
4. **Sensory & Synesthetic Triggers:**  
   Pure mechanical precision: whisper-quiet Gates carbon belt drive, hydraulic rotor gloss, smooth rolling velocity.
5. **Invariant Guardrails & Crop Safe-Zones:**  
   The vehicle occupies 75% of frame weight. Background scenery is strictly blurred into smooth motion streaks.
* **Director's Rig Prompt Blueprint:**
```text
...
### Archetype 15: The Rapid Transit Multi-Modal Fold & Elevator Blueprint
* **Universal Class:** The Specimen
