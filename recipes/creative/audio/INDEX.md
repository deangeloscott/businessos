# Shared Audio Starting Points

A compact menu of audio ideas for video, motion graphics, podcasts, presentations, product demos, audio ads, interfaces, and audio-only communication. The collection covers the role sound can play; the active model, user, and available tools can choose how to record, generate, edit, or mix it.

If an audio plan already exists, use it. If the visual idea needs a sound direction, choose one useful role and adapt it to the actual message, listener, placement, voice, source material, and rights. A recipe can be used directly as creative direction or turned into a tailored production prompt when that is the requested output. It is not a required track layout or mixing specification.

## Choose a starting point

| Job | Starting point |
|---|---|
| Explain one idea clearly in a human voice | [Clear spoken explanation](01-clear-spoken-explanation.md) |
| Support a message with mood and movement | [Music that supports the message](02-music-that-supports-the-message.md) |
| Make a visible or imagined action feel tangible | [Make an action tangible](03-make-an-action-tangible.md) |
| Give a recurring series or brand a small audio identity | [A recognizable sonic signature](04-recognizable-sonic-signature.md) |
