...
Ask for the business outcome in normal language. AURA may surface a useful Playbook and supporting Workflows; this file is only a human browse view.
...
- **Competitor Research** — Identify the competitors and substitutes that matter, understand what they are doing, compare the business against them, and derive supported implications. — common entry `competitor.analysis.competitive-position`
- **Competitor Monitoring** — Keep important competitive movement current and distinguish observed changes from unsupported assumptions about effectiveness or intent. — common entry `competitor.intelligence.ecosystem-radar`
...
| Capabilities | Compare capabilities in customer context. | `competitor.analysis.capability-comparison` |
| Positioning | Understand competitor positioning and message. | `competitor.analysis.positioning` |
...
| Long Video | Produce complete long-form video. | `content.production.long-video` |
| Podcast | Produce audio/podcast content. | `content.production.podcast` |
| Carousel | Produce a sequential visual carousel. | `content.production.carousel` |
| Presentation | Produce a clear presentation/slideshow. | `content.production.presentation` |
| Infographic | Produce an evidence-backed infographic. | `content.production.infographic` |
| Image | Produce an image/graphic. | `content.production.image` |
| Animation | Produce explanatory animation. | `content.production.animation` |
| Gif | Produce concise looping motion/GIF. | `content.production.gif` |
...
| Decision Drivers | Identify decision criteria, triggers, tradeoffs, and disqualifiers. | `customer.analysis.decision-drivers` |
| Jobs Outcomes | Identify customer jobs and desired progress. | `customer.analysis.jobs-outcomes` |
| Win Loss | Explain why comparable opportunities are won or lost. | `customer.analysis.win-loss` |
...
- **Customer Journey Optimization** — Understand the journey, identify the most important progression problem, diagnose the likely cause, improve it, and evaluate what changed. — common entry `customer-optimization.diagnosis.bottleneck-prioritization`
- **Retention and Churn** — Understand why customers leave or fail to realize value, improve the relevant experience, and evaluate durable retention rather than manipulating short-term staying behavior. — common entry `customer-optimization.intervention.retention`
...
| Retention | Improve durable retention through customer value. | `customer-optimization.intervention.retention` |
| Renewal | Improve healthy renewal readiness/progression. | `customer-optimization.intervention.renewal` |
| Repeat Purchase | Increase appropriate repeat purchase. | `customer-optimization.intervention.repeat-purchase` |
| Upsell Cross Sell | Improve appropriate additional purchase progression. | `customer-optimization.intervention.upsell-cross-sell` |
...
- **Industry Intelligence** — Discover and evaluate material news, research, regulation, technology, market shifts, and other external changes that could affect the organization. — common entry `industry.intelligence.ecosystem-radar`
- **Industry Rapid Response** — Build a fast, evidence-backed understanding of a time-sensitive external development and its plausible business implications. — common entry `industry.analysis.rapid-response`
...
| Vsl | Create a complete VSL persuasion system. | `marketing.assets.vsl` |
| Webinar | Create a complete value-first commercial webinar system. | `marketing.assets.webinar` |
| Email Sequence | Create a complete responsive commercial email sequence. | `marketing.assets.email-sequence` |
...
| Message Experiment | Test a marketing persuasion hypothesis and learn from response. | `marketing.experimentation.message-test` |
...
Core supplies shared organization memory, truth/evidence rules, decisions, continuity, measurement, Learning, and workspace integrity. It supports the business Playbooks rather than acting as another business Playbook.
...
See `PLAYBOOKS.md` for the high-level business jobs and `WORKFLOW-INDEX.md` for all detailed reusable procedures.
