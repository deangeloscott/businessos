...
5. [DETERMINISTIC] Require/create Approval when policy demands it and block execution until conditions are satisfied.
6. [DETERMINISTIC] Record authorization decision on the Action/Approval without modifying the underlying Opportunity rationale.
