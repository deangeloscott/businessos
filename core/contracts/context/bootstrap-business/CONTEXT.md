...
5. [AI] Identify material unknowns or contradictions that would change near-term work. Before asking, reuse any current authoritative answer already stored for this business. Ask only for information that cannot safely be discovered/inferred/reused and materially affects the requested action scope, compliance, economics, brand identity, or a real business decision; persist durable answers at the correct scope so later workflows do not ask again.
