...
## Run When
When a business provides or changes brand voice, visual rules, content preferences, channel conventions, approved references, or prohibited styles.

## Process
1. [HYBRID] Collect explicit instructions, brand guidelines, approved examples, rejected examples, reference Assets, and channel-specific preferences; distinguish mandatory rules from preferences.
