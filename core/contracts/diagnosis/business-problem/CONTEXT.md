...
4. [HYBRID] Rank hypotheses by potential business impact, current evidence, plausibility, and the cost/time of evidence needed to discriminate among them. Select the minimum additional evidence likely to materially change the diagnosis.
...
6. [AI] Integrate returned evidence; identify supported, contradicted, and unresolved hypotheses and the most likely bottleneck(s). Preserve competing explanations when evidence does not support a single cause.
