...
5. [AI] Describe material source/data quality limitations and confidence when the value is modeled, estimated, partial, or otherwise not a direct authoritative measurement.
...
## Failure / Fallback
- If the requested metric cannot be supported by available evidence, preserve the unresolved measurement need rather than inventing a value, zero, or direction.
