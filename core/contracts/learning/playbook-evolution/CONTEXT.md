...
4. [HYBRID] For a process change, keep only valuable operating knowledge: provider-neutral capability needs, relevant reads/writes, instructions, quality/verification criteria, and useful discovery terms for a new local playbook.
...
## Completion Criteria
A useful PlaybookEvolutionProposal exists, or the existing Learning remains the appropriate reusable guidance because formalizing another process artifact would not improve future organizational work.
