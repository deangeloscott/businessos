...
## Purpose
Make an intentionally selected, business-scoped WorkflowEvolutionProposal available as reusable AURA operational knowledge without modifying canonical AURA source.
...
6. [DETERMINISTIC] Resolve the effective playbook/local playbook and verify its instructions and the tools or resources appropriate to the work remain visible.
