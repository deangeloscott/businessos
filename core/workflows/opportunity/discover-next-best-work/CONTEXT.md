...
2. [AI] Reuse and inspect the strongest relevant first-party and canonical state already available. Treat missing structured metric/economic/outcome object types as representation facts, not proof that usable business evidence is absent.
