...
12. Existing customer-facing assets are not a truth loophole. Editing an existing webpage, ad, email, script, or other outward surface must obey the same business-truth boundary as creating a new one. AURA does not require a universal before/after mutation protocol; preserve evidence or a material `ChangeEvent` only when it will genuinely improve truth, verification, measurement, troubleshooting, or continuity.
