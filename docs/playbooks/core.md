...
- **[Review Monitoring Status](../../core/contracts/monitoring/status/CONTEXT.md)** — Show what AURA is monitoring, per-subject/source/signal cadence, notification intent, due work, and whether recurring execution is actually active.
