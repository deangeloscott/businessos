...
- **[Configure AURA Workspace](../../core/workflows/workspace/configure/CONTEXT.md)** — Choose simple, power-user, or organization deployment; optionally separate organization-owned state from product source; and keep versioning/Obsidian as optional adapters.
- **[Refresh Human Knowledge Layer](../../core/workflows/knowledge/refresh-human-layer/CONTEXT.md)** — Generate a traceable Markdown/Obsidian-friendly human view from canonical AURA state without creating a competing truth store.
- **[Ingest Human Knowledge Note](../../core/workflows/knowledge/ingest-human-note/CONTEXT.md)** — Register a human-authored workspace note as noncanonical source material and preserve useful claims/evidence through normal context handling.
...
- **[Query Business Truth](../../core/workflows/data/query-business-truth/CONTEXT.md)** — Query authoritative first-party business truth through the best currently available host/integration surface and preserve evidence-linked AURA references.
...
- [External Evidence Triangulation](../../core/workflows/intelligence/ecosystem/evidence-triangulation/CONTEXT.md)
- [External Source and Signal Discovery](../../core/workflows/intelligence/ecosystem/source-discovery/CONTEXT.md)
- [Maintain External Source Profile](../../core/workflows/intelligence/ecosystem/maintain-source-profile/CONTEXT.md)
- [Manage Attention](../../core/workflows/attention/manage/CONTEXT.md)
- [Manage Durable Handoff](../../core/workflows/continuity/manage-handoff/CONTEXT.md)
- [Manage Incident](../../core/workflows/incident/manage/CONTEXT.md)
- [Manage Insight](../../core/workflows/intelligence/manage-insight/CONTEXT.md)
- [Propose Canonical Context Update](../../core/workflows/context/propose-update/CONTEXT.md)
- [Publish Metric Observation](../../core/workflows/measurement/publish-metric/CONTEXT.md)
- [Publish Observation](../../core/workflows/intelligence/publish-observation/CONTEXT.md)
- [Qualify Opportunity](../../core/workflows/opportunity/qualify/CONTEXT.md)
- [Record Material Change](../../core/workflows/continuity/record-material-change/CONTEXT.md)
- [Record Verified Platform Change](../../core/workflows/intelligence/record-platform-change/CONTEXT.md)
- [Register Reusable Proof](../../core/workflows/intelligence/register-proof/CONTEXT.md)
- [Verify Material Change](../../core/workflows/verification/verify-change/CONTEXT.md)
