...
def record(bid,platform,topic,state_summary,owner_system='core',authority='unknown',materiality='unknown',change_summary=None,effective_at=None,source_refs=None,evidence_refs=None,affected_workflow_refs=None,affected_object_refs=None,verified_at=None,reverify_current=False):
    ...
    if reverify_current:
        ...
        for field,new_refs in [('source_refs',source_refs),('evidence_refs',evidence_refs),('affected_workflow_refs',affected_workflow_refs),('affected_object_refs',affected_object_refs)]:
    ...
    obj={
        ...
        'owner_system':owner_system,'platform':platform,'topic':topic,'semantic_key':key,
        'state_summary':norm(state_summary),'state_fingerprint':fp,'change_summary':change_summary,
...
def main():
    ap=argparse.ArgumentParser(description='Record/reverify versioned external platform state without modifying AURA software.')
    ...
    ap.add_argument('--owner-system',default='core')
