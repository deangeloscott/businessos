---
id: customer.intelligence.relevance-evaluation
type: detector
...
- ProductService
---
# Customer Relevance Evaluation

## Purpose
Evaluate whether shared intelligence from another semantic domain materially affects understanding what customers want, believe, choose, reject, say, and experience without duplicating the upstream Insight or launching expensive work automatically.
...
3. [AI] Evaluate the domain mechanism: Ask whether the evidence changes a customer hypothesis, reveals a customer question/need/alternative, provides behavioral evidence relevant to an existing Customer Insight, or warrants direct customer validation. Do not infer motivation solely from search/content/marketing performance.
