...
For an existing clip, the optional [editorial enhancement notes](../../../../../recipes/creative/ecommerce-video-lookbooks/notes/editorial-enhancement.md) can suggest one purposeful overlay, cutaway, caption, sound cue, color change, or silence. Use the [compositing and matching notes](../../../../../recipes/creative/ecommerce-video-lookbooks/notes/compositing-and-matching.md) only when an inserted element needs to belong to the shot. If the footage already communicates the point, skip both.
When a presenter, character, voice, or environment must remain recognizable across shots, the optional [creative identity and continuity note](../../../../../recipes/creative/ecommerce-video-lookbooks/notes/identity-and-continuity.md) can help identify the few anchors worth carrying forward.
