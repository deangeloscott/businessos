...
Use the [video concepts and craft menu](../../../../../recipes/creative/video/INDEX.md) and its optional [core motion](../../../../../recipes/creative/video/notes/core-motion.md), [platform and placement](../../../../../recipes/creative/video/notes/platform-placement.md), and [sensory/audio](../../../../../recipes/creative/video/notes/sensory-audio.md) notes for adaptable motion, comparison, continuity, platform, sound, and measurement ideas. Use the [motion graphics starting points](../../../../../recipes/creative/motion-graphics/INDEX.md) for animated type, numbers, diagrams, state changes, and demo callouts, and the [shared audio starting points](../../../../../recipes/creative/audio/INDEX.md) for cross-medium narration, music, Foley, and sonic identity. Use the [image menu](../../../../../recipes/creative/ecommerce-image-lookbooks/INDEX.md) when still anchors or scale references help. Choose only what serves the viewer's question; do not import fixed timings, platform statistics, or proof claims.
For an existing clip, the optional [editorial enhancement notes](../../../../../recipes/creative/video/notes/editorial-enhancement.md) can suggest one purposeful overlay, cutaway, caption, sound cue, color change, or silence. Use the [compositing and matching notes](../../../../../recipes/creative/video/notes/compositing-and-matching.md) only when an inserted element needs to belong to the shot. If the footage already communicates the point, skip both.
When a presenter, character, voice, or environment must remain recognizable across shots, the optional [creative identity and continuity note](../../../../../recipes/creative/video/notes/identity-and-continuity.md) can help identify the few anchors worth carrying forward.
