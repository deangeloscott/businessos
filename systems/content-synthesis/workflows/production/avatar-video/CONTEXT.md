...
## Run When
Use when synthetic/avatar presentation is actually permitted for the organization/use case and a presenter-led format is useful for the target audience/platform.
...
4. [INTEGRATION] Generate the avatar video with the active harness's available/authorized tools, or create a useful provider-neutral production specification when final rendering is not available here.
