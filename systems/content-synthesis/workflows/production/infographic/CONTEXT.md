...
7. [HYBRID] Preserve the useful versioned Asset and evidence/source lineage. Draw on pre-publish QA operating knowledge when the destination or artifact warrants an additional integrated review; no Run or completion ledger is required.
