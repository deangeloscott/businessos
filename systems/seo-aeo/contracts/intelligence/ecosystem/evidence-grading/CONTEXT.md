...
- If the organization wants to turn strong Learning into reusable process knowledge, `core.learning.playbook-evolution` is available. Cross-organization sharing uses explicit Innovation Exchange/export/adoption or deliberate AURA product-development work.
