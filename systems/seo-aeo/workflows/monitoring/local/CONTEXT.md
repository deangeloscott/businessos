...
## Business Outcome
Keep local-discovery evidence current enough to recognize meaningful gains or losses in customer exposure and the resulting opportunity for calls, visits, bookings, leads, and revenue while preserving location-specific differences and measurement uncertainty.
...
4. [AI] Treat stronger visibility for valuable local queries and realistic customer geographies as a meaningful upstream signal because it can increase the chance of customer discovery and action. Connect that signal to calls, bookings, directions, site actions, visits, leads, revenue, or other outcomes where observable; do not infer those outcomes solely from rank movement.
...
- Local visibility and downstream customer/business outcomes remain distinct while their credible pathway may inform priority.
