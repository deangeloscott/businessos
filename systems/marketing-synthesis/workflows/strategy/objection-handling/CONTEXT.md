...
7. [AI] Preserve the reusable objection-response strategy as an organization-owned Asset. Create a separate Opportunity, WorkRequest, or canonical change only when that distinct organizational meaning actually exists.
