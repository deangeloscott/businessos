...
## Run When
Use when a marketing asset must communicate an established price or commercial structure. An Opportunity or real durable WorkRequest may provide context but is not required.

## Process
1. [HYBRID] Resolve canonical Offer price, billing period, commitment, included value, conditions, taxes/fees where relevant, payment options, and current version.
