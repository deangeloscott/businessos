...
## Common jobs
- Define the persuasion problem or reusable brief → `marketing.intake.persuasion-brief`
- Diagnose a persuasion barrier → `workflows/diagnosis/`
- Positioning, messaging, value proposition, mechanism, proof, objections, Offer presentation → `workflows/strategy/` and `workflows/offer/`
- Landing page, VSL, webinar, email, ads, sales enablement, and other persuasion assets → `workflows/assets/` plus the relevant specialist family
- Campaign development → `workflows/campaigns/`
- Experiment or evaluate persuasion hypotheses → `workflows/experimentation/` and `workflows/measurement/`
- Reusable Marketing Learning → `workflows/learning/`
