...
- ProductService
---
# Marketing Relevance Evaluation

## Purpose
Evaluate whether shared intelligence from another semantic domain materially affects commercial persuasion without duplicating the upstream Insight or launching expensive work automatically.
...
3. [AI] Evaluate the domain mechanism: Ask whether the Insight changes positioning, message, proof, objections, offer presentation, awareness/stage assumptions, campaign opportunity, or commercial conversion hypothesis. Do not treat operational journey friction as a messaging problem without diagnosis.
