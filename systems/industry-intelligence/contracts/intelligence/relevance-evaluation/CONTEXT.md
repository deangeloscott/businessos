---
id: industry.intelligence.relevance-evaluation
type: detector
...
## Purpose
Evaluate whether shared intelligence from another semantic domain materially affects understanding material external environment change without duplicating the upstream Insight or launching expensive work automatically.
...
3. [AI] Evaluate the domain mechanism: Ask whether the evidence indicates a broader market/category/regulatory/technology/cultural development beyond one entity or customer cohort, or materially changes the relevance/evolution of an existing IndustryEvent.
