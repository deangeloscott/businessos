...
6. [HYBRID] Use `competitor.discovery.entity-resolution` when it materially helps to resolve/create one canonical Competitor record per true competitor and preserve evidence-backed domains, aliases, and public profiles. Reuse shared SourceProfile subject grouping where available; do not merge namesakes or ambiguous identities.
...
8. [HYBRID] Mark uncertainty and prioritize deeper profiling only for material candidates.
