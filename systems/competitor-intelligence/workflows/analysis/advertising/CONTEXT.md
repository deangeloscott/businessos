...
7. [HYBRID] When a material ad leads to a relevant public acquisition path, use Funnel Capture operating knowledge when it materially improves the analysis rather than analyzing the creative in isolation.
...
9. [DETERMINISTIC] Publish Observations/Insights, record source coverage/gaps and modality limitations, and surface persuasion implications directly for future Marketing work when useful.
