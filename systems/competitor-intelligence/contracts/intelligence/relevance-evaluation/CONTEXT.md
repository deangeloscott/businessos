---
id: competitor.intelligence.relevance-evaluation
type: detector
version: 1.1.0
...
- ProductService
---
# Competitor Relevance Evaluation

## Purpose
Evaluate whether shared intelligence from another semantic domain materially affects understanding persistent competitors and competitive strategy without duplicating the upstream Insight or launching expensive work automatically.
...
3. [AI] Evaluate the domain mechanism: Ask whether the evidence changes competitor identity/state, products, pricing, packaging, positioning, offers, customer perception, strategic movement, or a tactic-effectiveness hypothesis. Domain-specific SEO facts contribute evidence but do not automatically define overall competitor strategy.
