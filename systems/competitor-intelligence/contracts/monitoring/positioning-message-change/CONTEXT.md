---
id: competitor.monitoring.positioning-message-change
type: playbook
version: 1.3.0
...
- Offer
---
# Competitor Positioning and Message Change Watch

## Purpose
Detect material competitor positioning, claims, audience, or messaging changes against the last verified state.

## Business Outcome
Keep competitive intelligence current and distinguish meaningful change from cosmetic edits.

## Run When
Run on the monitoring cadence for priority competitors or when an external signal suggests a positioning, claims, audience, or messaging change.
