---
id: competitor.monitoring.pricing-offer-change
type: playbook
version: 1.3.0
...
- Offer
---
# Competitor Pricing and Offer Change Watch

## Purpose
Detect material competitor price, packaging, terms, or offer changes against the last verified state.

## Business Outcome
Keep competitive intelligence current and distinguish meaningful change from cosmetic edits.

## Run When
Run on the monitoring cadence for priority competitors or when an external signal suggests a price, packaging, terms, or offer change.
