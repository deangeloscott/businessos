...
3. [AI] Identify supported or testable hypotheses such as surprise cost, uncertainty, effort, forced account creation, payment limitation, trust, performance, accessibility, or technical failure. Draw on root-cause diagnosis, intervention-design, or payment-failure operating knowledge when those specialist methods materially improve the analysis.
