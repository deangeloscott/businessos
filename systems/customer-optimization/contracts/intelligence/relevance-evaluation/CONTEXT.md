...
- ProductService
---
# Customer Optimization Relevance Evaluation

## Purpose
Evaluate whether shared intelligence from another semantic domain materially affects customer progression and value realization without duplicating the upstream Insight or launching expensive work automatically.
...
3. [AI] Evaluate the domain mechanism: Ask whether the Insight changes expected journey behavior, identifies friction/risk at a transition, changes success/retention/expansion assumptions, or warrants new lifecycle diagnosis. Customer-stated motivations remain Customer Intelligence-owned.
