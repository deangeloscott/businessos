...
3. [AI] Combine stated churn reasons with behavioral predictors without treating predictors as motivations or correlation as causality.
...
5. [AI] Design targeted interventions tied to the supported mechanism rather than blanket discounts, reminders, or pressure. Use service recovery, communication, customer research, product/process, or other relevant operating knowledge directly when helpful.
